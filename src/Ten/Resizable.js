...
Ten.Resizable = new Ten.Class({
    ...
    setupToggleButton: function () {
        this.toggleButton = new Ten.Element('span', { className: 'toggle-button' }, new Ten.Element('img', { src: 'http://ugomemo.hatena.ne.jp/images/maximize.gif' }));
    ...
    setupResizeButton: function () {
        this.resizeButton = new Ten.Element('span', { className: 'resize-button' }, new Ten.Element('img', { src: 'http://ugomemo.hatena.ne.jp/images/resize.gif' }));
    ...
    startResize: function (e) {
        if (e.targetIsFormElements())
            return;
        this.delta = Ten.Position.subtract(Ten.Geometry.getElementPosition(this.window), Ten.Position.subtract(e.mousePosition(), Ten.Geometry.getElementPosition(this.resizeButton)));
        this.handlers = [
